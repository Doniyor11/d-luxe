(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".tabs-services__slider")) new core(".tabs-services__slider", {
                ...
                pagination: {
                    el: ".tabs-services__slider .swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".tabs-services__slider .swiper-button-prev",
                    nextEl: ".tabs-services__slider .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.5,
        ...
        document.addEventListener("DOMContentLoaded", (event => {
            ...
            const tabsSliders = document.querySelectorAll(".tabs-services__slider");
            if (tabsSliders.length && window.innerWidth <= 992.98) tabsSliders.forEach((slider => {
